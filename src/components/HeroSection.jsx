const HeroSection = () => {
  return (
    ...
    >
      ...
      <p className="mx-8 lg:mx-16 mt-8 lg:mt-20 xl:mt-[165px] text-center text-sm lg:text-[15px] font-roboto font-normal uppercase text-darkgray">Powering tools and integrations from companies all around the world( sponsor logos)</p>
    </section>
  );
};
